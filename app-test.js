const processResponse = require('./app.js');

describe('Should return proper values', function() {
  it('has value', function() {
    ...
    expect(processResponse[JSON]).toEqual(expectedResult);
  });
});

// I didnt finish testing //
// I get an error //
// I was trying to test at list the show wih one episode //
// I have to read more the documentation for jasmine testing framework//
